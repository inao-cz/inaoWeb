...
class SecurityController extends AbstractController
{
     ...
     * @throws Exception
     */
    #[Route(path: '/register/{invite}', name: 'security-register')]
    public function register(Request $request, UserPasswordHasherInterface $passwordEncoder, UserUtil $util, $invite = null) : Response
    {
        if(!$invite){
            return $this->redirectToRoute('index');
        }
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            $apiKey = new ApiKey();
            $apiKey->setOwner($user)->setApiKey($util->getRandomApiKey());
